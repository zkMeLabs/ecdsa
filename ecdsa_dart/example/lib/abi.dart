...
class ABI {
  ...
  static Transaction tokenTransfer({
    required EthereumAddress from,
    required EthereumAddress to,
    required num tokensAmount,
    required int decimals,
    required String tokenAddress,
  }) {
    final _contract = contract(contractName: "BasicToken", tokenAddress: tokenAddress);
    var function = _contract.function('transfer');

    final amount = Decimal.parse(tokensAmount.toString()) * (Decimal.ten.pow(decimals));
    var parameters = [to, amount.toBigInt()];
  ...
  static tokenTransferFunction(String tokenAddress) {}

  static DeployedContract contract(
      {String contractName = 'BasicToken', required String tokenAddress}) {
    final abi = ABI.get(contractName);
