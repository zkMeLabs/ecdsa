...
extension BigInteger {
    ...
    class Modulus {
        ...
        init(_ a: BigInteger, _ modulus: BigInteger) {
        ...
        func expMod(_ x: BigInteger) -> BigInteger {
            ...
            return BigInteger(fromMspace(result))
        }
    ...
    class Pow2Modulus: Modulus {
        ...
        override init(_ a: BigInteger, _ modulus: BigInteger) {
